import { Component, ElementRef, Input, ViewChild, AfterViewInit, OnDestroy, HostListener } from '@angular/core';
...
@Component({
  ...
  styleUrls: ['./circular-gallery.component.scss']
})
export class CircularGalleryComponent implements AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit() {
    ...
    this.app = new App(this.containerRef.nativeElement, {
      items: this.items,
      bend: this.bend,
      textColor: this.textColor,
